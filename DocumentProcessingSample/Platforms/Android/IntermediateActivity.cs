...
namespace DocumentProcessingSample
{
...
#pragma warning restore 618
    ...
    interface IActivityStateManager
    {
        Android.App.Activity? GetCurrentActivity();
    }

    class ActivityStateManager : IActivityStateManager
    {
        static ActivityStateManager? _default;
        public static ActivityStateManager Default => _default ??= new ActivityStateManager();

        public Android.App.Activity? GetCurrentActivity()
        {
            return Microsoft.Maui.Controls.Application.Current?.Windows[0]?.Handler?.MauiContext?.Services.GetService<Android.App.Activity>();
        }
    }
}
