namespace DocumentProcessingSample.Services
{
    ...
    public partial class FileService
    {
        ...
        /// <returns></returns>
        internal static async Task WriteStream(Stream stream, string? filePath)
        {
        ...
        /// <summary>
        /// Platform-specific implementation for saving files.
        /// </summary>
        internal static partial Task<string?> PlatformSaveAsAsync(string fileName, Stream stream);
    }
}
